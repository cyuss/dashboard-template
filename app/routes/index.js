...
import WelcomePage from './Dashboards/Welcome';
...
export const RoutedContent = () => {
    return (
        <Switch>
            <Redirect from="/" to="/dashboards/welcome" exact />
            
            <Route path="/dashboards/analytics" exact component={Analytics} />
            <Route path="/dashboards/projects" exact component={ProjectsDashboard} />
            <Route path="/dashboards/welcome" exact component={WelcomePage} />
            ...
            <Route component={ AccountCreationSuccess } path="/pages/creation-success" />
